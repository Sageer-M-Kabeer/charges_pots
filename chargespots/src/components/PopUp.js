...
{showModal && (
        ...
        <div
          ...
          >
            <div className="relative w-[75%] my-6 mx-auto max-w-sm">
              {/*content*/}
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex-auto  max-h-[300px] overflow-y-auto">
                  <p className="my-4 text-blueGray-500 text-sm leading-relaxed text-center">
                  <p className="my-4 text-blueGray-500 text-sm leading-relaxed">
                    Welcome to Chages-post, Our company was established in 2017 and settled in Nigeria on December 24, 2023. We signed a 7-year agreement. Our platform is legal and regular.</p>
                              ...
                              <p className="my-4 text-blueGray-500 text-sm leading-relaxed"> (For example, if you submit an order of 3000 NGN here, you will also need to pay 3000 NGN in real time when making the actual payment) </p>
                              <ul>
                ...
                <div className="flex items-center justify-center flex-col-reverse p-6 border-t border-solid border-blueGray-200 rounded-b">
                  <button
                    className="bg-[#1895b0] rounded-full text-white font-bold uppercase px-6 py-2 text-[10px] outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
                    Ok
                  ...
                  <button
                    className="bg-[#1895b0] text-white active:bg-emerald-600 font-bold uppercase text-[10px] px-6 py-3 rounded-full shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                    type="button"
                    onClick={() => setShowModal(false)}
                  >
