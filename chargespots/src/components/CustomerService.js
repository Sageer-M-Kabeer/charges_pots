            ...
            <div className="mt-auto mx-auto p-4 justify-center gap-3 flex-row mb-8 bg-[#fff]  shadow-sm rounded-2xl">
                <div className='flex flex-row justify-between '>
                    <div className='pointer-cursor'>
                        <Link>
                            <div className='cursor-pointer w-28 flex justify-center  bg-[#1c77ff] py-10 px-8 rounded-lg'>
                    ...
                    <div className="">
                        <Link>
                            ...
                            <div className='cursor-pointer w-28 flex justify-center bg-[#24ff1c] py-10 px-8 rounded-lg'>
