...
The system will randomly draw a reward of N100-300
            ...
            <div className="w-full fixed z-10 bottom-2 left-auto right-auto">
            ...
            <div className="relative  mb-8 bg-[#fff]  shadow-sm rounded-2xl">
                <div className="p-2">
                    ...
                    <div className='font-thin text-sm py-1 px-2 mb-3'>
            ...
            <div className="relative  mb-8 bg-[#fff]  shadow-sm rounded-2xl">
                <div className="p-2">
                    ...
                    <div className='py-10 px-2'>
                        <img className='w-full h-full max-w-[40px] max-h-10 md:h-1/2 md:w- md:p-40' src={te} alt='' />
                    </div>
                    <div className='font-thin text-sm py-1 px-2 mb-3'>
                        <p>Than you I have successfuly received my payment</p>
                    </div>    
