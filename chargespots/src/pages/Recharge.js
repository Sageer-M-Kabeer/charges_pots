                ...
                <div className="min-h-full">
                    ...
                    <div className="relative mt-8 mb-8 bg-[#fff]  shadow-sm rounded-2xl">
                        <div className="p-8">
                            ...
                            <button className='py-2 px-4 bg-blue-600 text-white rounded-lg z-[999] font-extralight fixed bottom-4 w-[80%] left-auto right-auto'>Send Request</button>
                            </div>
                            ...
                            <div className='flex justify-between flex-col '>
                                <div className='flex justify-between flex-col mb-4'>
                                    ...
                                    <div className='flex justify-between items-center '>
                                        ...
                                        <button className='py-2 px-4 bg-blue-600 text-white rounded-lg font-extralight'>copy</button>
                                    </div>
